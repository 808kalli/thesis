...
class LeRobotDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        # # LIBERO OBJECT 10 EPISODE FINE-TUNING
        # manual_ids = [0, 1, 3, 4, 6, 7, 9, 12, 14, 16]
        ...
        # # 1 episode per task libero spatial
        # # manual_ids = [0, 1, 3, 6, 11, 17, 19, 20, 22, 29]
        ...
        # # holdout_tasks_3_to_9
        # # manual_ids = [0, 1, 2, 3, 4, 5, 7, 10, 13, 15, 16, 23, 27, 30, 31, 37, 40, 41, 43, 48, 52, 53, 68, 72, 73, 75, 76, 77, 78, 79, 80, 82, 88, 98, 99, 104, 110, 112, 113, 127, 133, 135, 143, 154, 155, 157, 159, 160, 168, 169, 172, 173, 180, 182, 185, 187, 192, 195, 200, 201, 204, 208, 209, 211, 212, 213, 220, 221, 224, 233, 235, 237, 241, 244, 258, 260, 263, 264, 265, 273, 276, 278, 282, 283, 290, 300, 301, 303, 314, 315, 316, 320, 321, 325, 330, 333, 334, 337, 343, 344, 345, 346, 350, 351, 352, 358, 359, 363, 364, 365, 374, 379, 384, 385, 386, 390, 394, 400, 402, 405, 416, 419, 423, 424, 426, 428, 431]
